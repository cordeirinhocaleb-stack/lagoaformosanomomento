...
export const InspectorTextBlock: React.FC<InspectorTextBlockProps> = ({ block, onUpdate }) => {
  ...
  const renderPanel = () => {
    ...
    if (['impact_quote', 'vintage_letter'].includes(currentVariant)) {
    ...
    if (['checklist_pro', 'bullets_clean', 'bullets_square', 'numbered_steps', 'timeline_dots'].includes(currentVariant)) {
