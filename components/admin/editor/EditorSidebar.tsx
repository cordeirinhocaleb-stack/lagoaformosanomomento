...
const EditorSidebar: React.FC<EditorSidebarProps> = ({ onAddBlock, darkMode = false }) => {
            ...
            customContent: (
                <div className="grid grid-cols-1 gap-3 p-1">
                    ...
                    >
                        ...
                        <div>
                            <span className={`text-[11px] font-black uppercase tracking-widest block mb-0.5 ${darkMode ? 'text-zinc-200' : 'text-zinc-800'}`}>Vídeo (YouTube)</span>
