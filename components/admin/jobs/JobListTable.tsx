...
const JobListTable: React.FC<JobListTableProps> = ({ jobs, loading, onEdit, onDelete }) => {
    ...
    if (jobs.length === 0) {
        return (
            <div className="bg-gray-50 rounded-2xl p-12 text-center border border-gray-100 border-dashed">
                ...
                <h3 className="text-lg font-bold text-gray-900">Nenhuma vaga encontrada</h3>
                <p className="text-gray-500 text-sm mt-1">Tente ajustar os filtros ou adicione uma nova vaga.</p>
            </div>
        );
    }
