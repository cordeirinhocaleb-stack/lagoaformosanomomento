...
const LivePreviewStage: React.FC<LivePreviewStageProps> = ({ popupSet, selectedItemId }) => {
    ...
    return (
        <div className="flex flex-col h-full w-full bg-gray-50 rounded-[2rem] overflow-hidden border border-gray-200 shadow-inner relative group">
            ...
            {/* Toolbar */}
            <div className={`absolute top-4 left-4 right-4 z-50 flex flex-wrap items-center justify-between gap-2 p-2 bg-white/90 backdrop-blur-md rounded-2xl border border-gray-200 shadow-lg transition-opacity ${isFullScreenMobile ? 'opacity-30 hover:opacity-100' : 'opacity-100 lg:opacity-0 lg:group-hover:opacity-100'} pointer-events-auto`}>
                ...
                <div className="flex items-center gap-1 bg-white border border-gray-100 px-2 py-1 rounded-xl shadow-sm overflow-x-auto scrollbar-hide max-w-[150px] md:max-w-none">
