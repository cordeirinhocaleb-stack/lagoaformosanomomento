...
import { updateCommercialData, getCommercialData } from '../../../../services/users/userService';
                                ...
                                >
                                    ...
                                    <div className="flex-1 min-w-0 flex flex-col justify-center">
                                        ...
                                        <div className={`inline-flex items-center gap-1.5 px-2 py-1 rounded-md text-[10px] font-black w-fit ${darkMode ? 'bg-white/5 text-gray-300' : 'bg-gray-50 text-gray-600'}`}>
                                            <img src={lfnmCoin} alt="$" className="w-3.5 h-3.5 object-contain animate-coin-sm" />
                                            {item.cost}
                                        </div>
                                    </div>
