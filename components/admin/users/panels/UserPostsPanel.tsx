...
const UserPostsPanel: React.FC<UserPostsPanelProps> = ({ userId, posts = [] }) => {
        ...
        <div className="space-y-4 mb-6">
            ...
            {posts.length > 0 ? (
                <div className="space-y-2">
                    {posts.map((post) => (
                        <div key={post.id} className="bg-white rounded-xl p-4 border border-gray-100 hover:border-gray-200 transition-colors group">
