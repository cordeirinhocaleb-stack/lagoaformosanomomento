...
export const SlideContentLayer: React.FC<SlideContentLayerProps> = ({ 
    ...
    const fontStyle = { 
        fontFamily: textStyle?.fontFamily || theme.recommendedFontFamily,
    ...
    const titleSizeClass = { 'xl': 'text-2xl', '2xl': 'text-3xl md:text-4xl', '3xl': 'text-4xl md:text-5xl' }[textStyle.titleSize || '2xl'];
    const bodySizeClass = { 'sm': 'text-xs', 'md': 'text-sm', 'lg': 'text-base' }[textStyle.bodySize || 'md'];
