    ...
    >
      ...
      <div className="relative w-full h-full z-30 flex items-center px-4 pointer-events-auto">
        <div className="w-full h-full relative group cursor-pointer" onClick={onHomeClick}>
          {/* Microfone Aumentado e Girando (Moeda 3D) */}
          <div className="absolute left-[-6%] top-1/2 -translate-y-1/2 w-[45vw] h-[45vw] md:left-[0%] md:w-[35vw] md:h-[35vw] z-40 shrink-0 perspective-1000">
            <img
              src={brandIconUrl}
              className="w-full h-full object-contain drop-shadow-[0_2vw_4vw_rgba(0,0,0,0.8)] animate-coin-spin"
              alt="Brand Icon"
