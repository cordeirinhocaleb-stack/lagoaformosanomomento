...
import { getTermsOfServiceContent, TERMS_VERSION, TERMS_LAST_UPDATED } from '@/constants/termsOfService';
...
export default function TermosPage() {
    ...
    const termsContent = getTermsOfServiceContent(
        ctrl.user?.name || 'Visitante',
        ctrl.user?.email || 'email@não.informado'
    );
                ...
                <div className="flex flex-col md:flex-row gap-12 items-start">
                    ...
                    <aside className="w-full md:w-64 shrink-0 space-y-2 sticky top-32">
                        <div className="p-6 bg-gray-50 rounded-2xl border border-gray-100 mb-6">
                            ...
                            <nav className="space-y-1">
                                <a href="/termos" className="flex items-center justify-between p-3 rounded-xl bg-red-600 text-white font-black uppercase text-[10px] tracking-widest shadow-lg shadow-red-500/20">
                    ...
                    <div className="flex-1 bg-white border border-gray-100 rounded-[2.5rem] shadow-2xl p-8 md:p-16 relative overflow-hidden">
                        <div className="inline-flex items-center gap-3 text-red-600 mb-8">
                            ...
                            <span className="text-xs font-black uppercase tracking-[0.2em]">Condições Gerais</span>
                        </div>
                        ...
                        <h1 className="text-4xl md:text-6xl font-black uppercase italic tracking-tighter leading-none mb-12 border-b border-gray-100 pb-8">
                            Termos de <br /><span className="text-red-600">Uso do Portal</span>
                        </h1>

                        <div className="prose prose-red max-w-none prose-headings:font-black prose-headings:uppercase prose-headings:italic prose-headings:tracking-tighter prose-p:text-gray-600 prose-p:leading-relaxed prose-strong:text-gray-900 prose-blockquote:border-red-600 prose-blockquote:bg-red-50 prose-blockquote:rounded-r-xl">
                            <ReactMarkdown>
                                {termsContent}
                            </ReactMarkdown>
                        </div>
