...
const NewsCard: React.FC<NewsCardProps> = ({ news, featured, onClick, isZoomed, onZoomChange }) => {
    ...
    const handleContainerClick = (e: React.MouseEvent | React.TouchEvent) => {
        ...
        // Se for duplo clique (menos de 300ms), SEMPRE navega
        ...
        // Aguarda 300ms para ver se vai ter segundo clique
        clickTimeoutRef.current = setTimeout(() => {
            // Single click - alterna entre expandido/fechado
            setMobileActive(!isMobileActive);

            // Se está abrindo, faz scroll
            if (!isMobileActive) {
