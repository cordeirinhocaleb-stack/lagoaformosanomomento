...
const ConstructionPage: React.FC<ConstructionPageProps> = ({ user, onLogin, onLogout, onShowLogin, disableSignup }) => {
    ...
    return (
        ...
        >
            ...
            <div className="z-20 relative flex flex-col items-center justify-center gap-12 w-full max-w-5xl px-6">

                <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16 scale-90 md:scale-100 transition-all">
                    {/* Logo Icon (BIGGER + JUMP + SPIN) */}
                    <div
                        className="w-[45vw] md:w-[20vw] h-[45vw] md:h-[20vw] relative flex-shrink-0 animate-fade-in-up cursor-pointer"
                        ...
                        <div className={`w-full h-full ${micTipping ? 'animate-mic-tip' : ''}`}>
                            <img
                                ...
                                style={{
                                    ...
                                    transition: `transform ${spinState.duration}s cubic-bezier(0.34, 1.56, 0.64, 1)`
                                }}
                                alt="Logo Icon"
                            />
                        </div>
                    ...
                    <div className="flex flex-col items-center md:items-start">
                        <div className="flex flex-col font-[1000] uppercase tracking-tighter leading-[0.85] text-center md:text-left">
                            <InteractiveWord text="LAGOA" className="text-[12vw] md:text-[6vw] text-white" />
                            <InteractiveWord text="FORMOSA" className="text-[12vw] md:text-[6vw] text-red-600" />
                        </div>

                        {/* Ribbons / Status */}
                        <div className="flex items-center gap-4 mt-6">
                            <div className="bg-red-600 px-6 py-2 skew-x-[-15deg] shadow-[0_0_20px_rgba(220,38,38,0.6)]">
                            ...
                            <div className="bg-yellow-500/10 backdrop-blur-md px-4 py-2 border border-yellow-500/50 skew-x-[-15deg] animate-pulse">
