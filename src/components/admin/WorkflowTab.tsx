      ...
      <div className="animate-fadeIn w-full">
         ...
         <div className="flex gap-4 mb-8 bg-white p-2 rounded-2xl w-full md:w-fit shadow-sm border border-gray-100 overflow-x-auto">
            <button
               ...
               className={`px-6 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all whitespace-nowrap ${subTab === 'queue' ? 'bg-black text-white shadow-md' : 'text-gray-400 hover:bg-gray-50'
                  }`}
            >
               Fila de Aprovação
            ...
            <button
               ...
               className={`px-6 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all whitespace-nowrap ${subTab === 'analytics' ? 'bg-black text-white shadow-md' : 'text-gray-400 hover:bg-gray-50'
                  }`}
            >
               Acervo & Métricas
            </button>
                  ...
                  newsHistory.filter(n => n.status !== 'published').map(n => (
                     <div key={n.id} className="bg-white p-8 rounded-[3rem] border shadow-sm hover:shadow-xl transition-all border-l-8 border-amber-500 group relative">
                        <button
                           ...
                           className="absolute top-4 right-4 w-8 h-8 rounded-full bg-gray-50 text-gray-400 hover:bg-red-600 hover:text-white flex items-center justify-center transition-all opacity-100 lg:opacity-0 lg:group-hover:opacity-100"
                           title="Excluir"
                        >
            ...
            <div className="space-y-8 animate-fadeIn w-full">
               ...
               <div className="flex flex-col md:flex-row gap-4">
                  ...
                  <select
                     ...
                     className="px-6 py-3 bg-white rounded-2xl border border-gray-100 outline-none font-bold text-sm uppercase text-gray-600 focus:border-black w-full md:min-w-[200px]"
                  >
                              ...
                              return (
                                 <tr key={post.id} className="hover:bg-gray-50/50 transition-colors group cursor-pointer" onClick={() => onEdit(post)}>
                                    ...
                                    <td className="p-6 text-right flex justify-end gap-2 items-center">
                                       <span className={`px-3 py-1 rounded-full text-[8px] font-black uppercase tracking-widest inline-block ${post.status === 'published' ? 'bg-green-100 text-green-700' :
                                       ...
                                       <button
                                          ...
                                          className="w-8 h-8 rounded-full bg-gray-50 hover:bg-red-600 hover:text-white transition-all flex items-center justify-center opacity-100 lg:opacity-0 lg:group-hover:opacity-100 border border-gray-200 hover:border-red-600"
                                          title="Excluir"
                                       >
